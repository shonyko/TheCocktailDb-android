package ro.alexk.thecocktaildb.ui.login
...
import ro.alexk.thecocktaildb.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginViewModel = LoginViewModel(dependencyContainer.loginRepository)
